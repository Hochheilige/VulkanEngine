...
int main(int argc, char* argv[]) {
	...
	//depthImage.Init(*base, vk::Format::eD16Unorm, vk::ImageAspectFlagBits::eDepth, true);
	...
	//renderPass.Create(base->GetDevice(), base->GetFormat(), depthImage.GetFormat());
	//
	...
	//);
	//framebuffer.Create(base->GetDevice(), renderPass.GetRenderPass(), swapchain);
	//
